<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF6B6B,100:4ECDC4&height=200&section=header&text=Assembly%20Language%20Programs&fontSize=40&fontColor=ffffff&animation=fadeIn&fontAlignY=38&desc=Low-Level%20Programming%20Collection&descAlignY=58&descSize=18" />
</div>
...
[![GitHub stars](https://img.shields.io/github/stars/saadoxyz/Assembly-language-mini-projects?style=social)](https://github.com/saadoxyz/Assembly-language-mini-projects)
[![GitHub forks](https://img.shields.io/github/forks/saadoxyz/Assembly-language-mini-projects?style=social)](https://github.com/saadoxyz/Assembly-language-mini-projects/fork)
[![GitHub issues](https://img.shields.io/github/issues/saadoxyz/Assembly-language-mini-projects?color=red&style=flat-square)](https://github.com/saadoxyz/Assembly-language-mini-projects/issues)
[![License](https://img.shields.io/badge/license-MIT-blue.svg?style=flat-square)](LICENSE)

</div>

<div align="center">
  <img src="https://readme-typing-svg.herokuapp.com?font=Fira+Code&pause=1000&color=00D4AA&center=true&vCenter=true&width=500&lines=x86+Assembly+Programming;Low-Level+System+Operations;Educational+Code+Examples;Stack+Frame+Implementations;String+%26+Math+Operations" alt="Typing SVG" />
</div>
...
```mermaid
graph TD
    A[🎓 Learning Assembly] --> B[📊 Arithmetic Operations]
    A --> C[🔤 String Manipulation]
    A --> D[🔄 Control Flow & Loops]
    A --> E[📚 Stack Operations]
    
    B --> F[Addition, Subtraction]
    B --> G[Multiplication, Division]
    B --> H[Multi-digit Operations]
    
    C --> I[Input/Output Handling]
    C --> J[String Reversal]
    C --> K[Character Processing]
    
    D --> L[Loops & Iterations]
    D --> M[Recursion Examples]
    D --> N[Conditional Logic]
    
    E --> O[Stack Frames]
    E --> P[Parameter Passing]
    E --> Q[Memory Management]
```
...
![MASM](https://img.shields.io/badge/MASM-Required-blue?style=flat-square&logo=microsoft)
![DOSBox](https://img.shields.io/badge/DOSBox-Recommended-orange?style=flat-square&logo=dos)
![x86](https://img.shields.io/badge/x86-Architecture-green?style=flat-square&logo=intel)
...
<div align="center">
  <img src="https://github-readme-stats.vercel.app/api?username=saadkhan&repo=assembly-programs&show_icons=true&theme=tokyonight&hide_border=true" />
</div>
...
```mermaid
journey
    title Assembly Learning Journey
    section Beginner
      Hello World: 5: Beginner
      Basic I/O: 4: Beginner
      Simple Math: 4: Beginner
    section Intermediate
      Loops & Logic: 3: Intermediate
      String Operations: 3: Intermediate
      Stack Usage: 2: Intermediate
    section Advanced
      Recursion: 2: Advanced
      Data Structures: 1: Advanced
      Optimization: 1: Advanced
```
...
|---------|----------|-----------|
| **🔢 Basic I/O** | Hello World, Character I/O | ![Beginner](https://img.shields.io/badge/-Beginner-green) |
| **➕ Arithmetic** | Add, Subtract, Multiply, Divide | ![Beginner](https://img.shields.io/badge/-Beginner-green) |
| **🔄 Control Flow** | Loops, Conditionals | ![Intermediate](https://img.shields.io/badge/-Intermediate-yellow) |
| **🔤 String Handling** | Reverse, Encryption, Vowels | ![Intermediate](https://img.shields.io/badge/-Intermediate-yellow) |
| **📚 Stack Operations** | Stack Frames, Parameter Passing | ![Advanced](https://img.shields.io/badge/-Advanced-red) |
| **♻️ Recursion** | Factorial, Fibonacci | ![Advanced](https://img.shields.io/badge/-Advanced-red) |
| **🏗️ Data Structures** | Arrays, Trees | ![Advanced](https://img.shields.io/badge/-Advanced-red) |
...
[![Contributors](https://img.shields.io/badge/Contributors-Welcome-brightgreen?style=for-the-badge&logo=github)](https://github.com/saadkhan/assembly-programs/graphs/contributors)
[![Issues](https://img.shields.io/badge/Issues-Open-red?style=for-the-badge&logo=github)](https://github.com/saadkhan/assembly-programs/issues)
[![Pull Requests](https://img.shields.io/badge/PRs-Welcome-blue?style=for-the-badge&logo=github)](https://github.com/saadkhan/assembly-programs/pulls)
...
[![Assembly Language](https://img.shields.io/badge/Book-Assembly%20Language%20Programming-blue?style=flat-square)](https://example.com)
[![x86 Architecture](https://img.shields.io/badge/Guide-x86%20Architecture-green?style=flat-square)](https://example.com)
[![MASM Documentation](https://img.shields.io/badge/Docs-MASM%20Reference-orange?style=flat-square)](https://docs.microsoft.com/en-us/cpp/assembler/masm/)
...
[![GitHub Issues](https://img.shields.io/badge/GitHub-Issues-red?style=for-the-badge&logo=github)](https://github.com/saadkhan/assembly-programs/issues)
[![Discussions](https://img.shields.io/badge/GitHub-Discussions-purple?style=for-the-badge&logo=github)](https://github.com/saadkhan/assembly-programs/discussions)
[![Email](https://img.shields.io/badge/Email-Contact-blue?style=for-the-badge&logo=gmail)](mailto:saad@example.com)
...
[![Star](https://img.shields.io/badge/⭐-Star%20this%20repo-yellow?style=for-the-badge)](https://github.com/saadkhan/assembly-programs)
[![Fork](https://img.shields.io/badge/🍴-Fork%20this%20repo-green?style=for-the-badge)](https://github.com/saadkhan/assembly-programs/fork)
[![Share](https://img.shields.io/badge/📢-Share%20with%20friends-blue?style=for-the-badge)](https://twitter.com/intent/tweet?text=Check%20out%20this%20awesome%20Assembly%20Language%20collection!&url=https://github.com/saadkhan/assembly-programs)
...
<div align="center">
  <img src="https://capsule-render.vercel.app/api?type=waving&color=0:FF6B6B,100:4ECDC4&height=120&section=footer&text=Happy%20Assembly%20Programming!&fontSize=24&fontColor=ffffff&animation=twinkling&fontAlignY=75" />
